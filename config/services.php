...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace l'ancienne intégration Make.com : synchronisation directe avec
    | l'API Google Calendar v3 via un compte de service (pas de flux OAuth
    | consentement — outil interne mono-organisation). Chaque calendrier
