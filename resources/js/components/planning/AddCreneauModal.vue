        ...
        <div class="flex flex-col gap-4">
            ...
            <div>
                ...
                <input
                    ...
                    :min="context?.weekMin"
                    :max="context?.weekMax"
                    class="w-full px-3.5 py-2.5 border-[1.5px] border-ink-faint rounded-lg text-base font-body
                           text-ink bg-surface-2 outline-none transition
                           focus:border-accent focus:bg-white focus:shadow-[0_0_0_3px_rgba(3,105,161,0.2)]"
                >
                <p class="text-[11.5px] text-ink-muted mt-1.5 min-h-[18px]">{{ hintText }}</p>
            </div>
            ...
            <div class="flex gap-2">
                <button
                    @click="submit"
                    :disabled="creating"
                    class="flex-1 min-h-[48px] px-4 py-2.5 bg-accent hover:bg-accent-dark text-white text-[13px]
                           font-bold rounded-lg shadow-[0_3px_12px_rgba(3,105,161,0.3)] transition-all
                ...
                <button
                    @click="close"
                    class="px-4 py-2.5 border-[1.5px] border-ink-faint text-ink-muted hover:bg-surface-3
                           hover:text-ink text-[13px] font-semibold rounded-lg transition-colors cursor-pointer
                           min-h-[48px]"
                >
                    Annuler
                </button>
