                ...
                <tbody>
                    @foreach($personnes as $personne)
                        ...
                        <tr class="border-b border-surface-3 last:border-0 hover:bg-surface-2 transition-colors">
                            ...
                            <td class="px-5 py-3">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11.5px] font-semibold {{ $si['bg'] }} {{ $si['text'] }}">
            ...
            @foreach($personnes as $personne)
                ...
                <div class="px-4 py-3.5">
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                        ...
                        @endif
                        <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-semibold {{ $si['bg'] }} {{ $si['text'] }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ $si['dot'] }} flex-shrink-0"></span>
                            {{ $personne->statut }}
                        </span>
