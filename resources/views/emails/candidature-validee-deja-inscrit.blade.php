        ...
        * {
        ...
        .stripe {
            ...
            background: repeating-linear-gradient(90deg,
                    #2d8022 0px, #2d8022 8px, #3a9e2e 8px, #3a9e2e 10px,
                    #4ab83e 10px, #4ab83e 12px, #3a9e2e 12px, #3a9e2e 14px,
                    #2d8022 14px, #2d8022 22px, #ffffff 22px, #ffffff 28px);
        }
    ...
    <div class="shell">
        <div class="wrapper">
            ...
            <div class="header">
                ...
                <div class="mission-title">Votre accès est activé&nbsp;!</div>
            ...
            <div class="body">
                ...
                <p class="body-text">
                    ...
                    <strong>validée</strong> par l'équipe d'administration.
                    Bienvenue dans l'équipe&nbsp;!
                </p>

                {{-- Already has password info box --}}
                <div class="info-box">
                    <span class="info-box-icon">✅</span>
                    <div class="info-box-content">
                        <div class="info-box-title">Vous avez déjà un compte AMANA</div>
                ...
                <div class="features-card">
                    <div class="features-card-label">&#10022; &nbsp; Depuis AMANA Planning, vous pouvez</div>
