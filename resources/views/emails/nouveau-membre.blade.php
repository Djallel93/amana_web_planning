...
<body>
    <div class="shell">
        <div class="wrapper">
            ...
            <div class="header">
                ...
                <div class="mission-badge">Administration</div>
                <div class="mission-title">Nouvelle candidature</div>
                <div class="mission-subtitle">En attente de validation</div>
            </div>
            ...
            <div class="body">
                ...
                <div class="candidat-card">
                    <div class="candidat-card-label">&#10022; &nbsp; Informations du candidat</div>
                    <div class="info-row">
                        <span class="info-icon">👤</span>
                        <span class="info-text">
                            <strong>{{ $candidat->prenom }} {{ strtoupper($candidat->nom) }}</strong>
                        </span>
                    </div>
                    <div class="info-row">
                        <span class="info-icon">✉️</span>
                        <span class="info-text">{{ $candidat->email }}</span>
                    </div>
                    @if($candidat->telephone)
                        <div class="info-row">
                            <span class="info-icon">📞</span>
                            <span class="info-text">{{ $candidat->telephone }}</span>
                        </div>
                    @endif
                    <div class="info-row">
                        <span class="info-icon">📅</span>
    ...
    : 'Non renseignée' }}
                        ...
                        @foreach(['Vendredi', 'Samedi'] as $jour)
                            <div class="restriction-day">
                                ...
                                @if($candidat->restrictions->where('jour', $jour)->isEmpty())
                                    <div class="restriction-item" style="color:#7a9e6e; font-style:italic;">
                                        Non renseigné
                                    </div>
                                @endif
                            </div>
                ...
                {{-- CTA --}}
                <div class="cta-wrap">
                    <a href="{{ $urlValidation }}" class="cta-button">
