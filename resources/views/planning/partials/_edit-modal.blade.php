...
<div class="fixed inset-0 bg-black/45 backdrop-blur-sm z-[400] flex items-center justify-center p-4
        opacity-0 pointer-events-none transition-opacity duration-200" id="editModalBackdrop"
    ...
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-sm transform scale-95 transition-transform duration-200"
        ...
        <div class="flex items-center gap-2.5 px-5 py-4 border-b border-surface-3">
            ...
            <span class="font-heading text-[14px] font-semibold text-ink flex-1" id="modalTitle">Modifier
                l'assignation</span>
        ...
        <div class="px-5 py-4 flex flex-col gap-4">
            ...
            <div>
                ...
                <div class="flex flex-col gap-2 sm:flex-row sm:items-stretch">
                    <select id="modalPersonSelect" class="w-full flex-1 px-3 py-2.5 border-[1.5px] border-ink-faint rounded-lg text-base font-body text-ink bg-surface-2 outline-none transition
                    ...
                    <button onclick="saveAssignation()" id="modalSaveBtn"
                        class="w-full sm:w-auto px-4 py-2.5 bg-accent hover:bg-accent-dark text-white text-[13px] font-bold rounded-lg
            ...
            <div>
                ...
                <div class="flex gap-2 flex-wrap">
                    <button onclick="unassignTask()" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-[12.5px] font-semibold rounded-lg cursor-pointer transition-colors min-h-[44px]
                                    bg-rose-50 border border-rose-200 text-rose-700 hover:bg-rose-100">
                        ✕ Désassigner
                    </button>
                    <button onclick="deleteCreneauFromModal()" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-[12.5px] font-semibold rounded-lg cursor-pointer transition-colors min-h-[44px]
                                    bg-rose-50 border border-rose-200 text-rose-700 hover:bg-rose-100">
