                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" id="date_debut" name="date_debut"
                                value="{{ old('date_debut', now()->toDateString()) }}" min="{{ now()->toDateString() }}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="semaines" name="semaines" value="{{ old('semaines', 4) }}" min="1"
                                max="52" required>
                    ...
                    <form action="{{ route('planning.rollback') }}" method="POST" id="rollbackForm">
                        ...
                        <div class="rollback-options">
                            <label class="rollback-option selected" id="opt-total">
                                <input type="radio" name="rollback_type" value="total" onchange="onRollbackTypeChange(this)"
                                    checked>
                        ...
                        <div class="week-checklist" id="weekChecklist">
                            <div class="checklist-controls">
                                <button type="button" class="btn btn-ghost btn-sm" onclick="checkAll(true)">Tout
                                    sélectionner</button>
                                <button type="button" class="btn btn-ghost btn-sm" onclick="checkAll(false)">Tout
                            ...
                            @foreach($byWeek as $weekLabel => $items)
                                <div class="week-check-item">
                                    ...
                                    <label for="week_{{ $loop->index }}" style="cursor:pointer;flex:1;">
                                        {{ $weekLabel }}
                                        <span style="color:var(--ink-muted);font-size:11.5px;margin-left:6px;">({{ count($items) }}
                                            créneaux)</span>
                                    </label>
                                </div>
                            @endforeach
                        ...
                        <button type="submit" class="btn btn-warning" style="width:100%;justify-content:center;margin-top:14px;"
