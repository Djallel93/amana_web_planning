 ...
 *
 * Effet de bord (voir regenererSuiteAbsence()) :
...
class AbsencesController extends Controller
{
    ...
    public function store(StoreAbsenceRequest $request): RedirectResponse
    {
        ...
        $regeneration = $this->regenererSuiteAbsence($absence);
     ...
     */
    private function regenererSuiteAbsence(Absence $absence): ?array
    {
        ...
        Log::info('[AbsencesController] Régénération automatique suite à absence', [
        ...
        try {
            ...
            Log::error('[AbsencesController] Échec de la régénération automatique', [
                'id_absence' => $absence->id,
                'error' => $e->getMessage(),
            ]);
        ...
        if (config('services.make.webhook_url')) {
            ...
            Log::info('[AbsencesController] Webhook Make.com dispatché en queue (POST) suite à régénération automatique.');
        }
