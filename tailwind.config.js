...
export default {
    ...
    theme: {
        extend: {
            ...
            // Utilisée pour l'entrée en fondu des sections du guide
            // d'utilisation (resources/views/guide/index.blade.php).
            // 'both' fige l'état de départ (opacity:0) avant que l'animation
            // ne démarre, pour éviter tout flash de contenu déjà visible.
            keyframes: {
                fadeInUp: {
